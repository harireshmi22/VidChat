...
import { Video, ArrowLeft, Eye, EyeOff, Lock, Mail, User } from "lucide-react";
        ...
        <Card className="border-zinc-200/80 bg-white shadow-xl shadow-zinc-200/50 rounded-2xl p-4 sm:p-6">
          <CardHeader className="text-center space-y-3 pb-6">
            ...
            <div className="space-y-1">
              <CardTitle className="text-2xl font-semibold tracking-tight text-zinc-900">Create account</CardTitle>
              <CardDescription className="text-zinc-500 text-sm">
                Join AuraCall today to host secure rooms
              </CardDescription>
              {error && (
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-4 pb-4">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="name" className="text-zinc-700 text-xs font-semibold">Full Name</Label>
              ...
              <div className="space-y-1.5">
                <Label htmlFor="confirm-password" className="text-zinc-700 text-xs font-semibold">Confirm Password</Label>
                <div className="relative">
                  <Lock className="absolute left-3 top-3 h-4.5 w-4.5 text-zinc-400" />
                  <Input
                    id="confirm-password"
...
export default function Signup() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-[#f8f9fa] text-zinc-500">Loading signup...</div>}>
      <SignupContent />
    </Suspense>
  );
}
